...
M.base = {
	...
	music = platform.join_path(platform.home_dir, platform.is_windows and "Nextcloud\\Musique"),
}
...
M.commands = {
	...
	music_player = platform.is_windows and { "termusic" },

	-- File search commands
	file_search = platform.is_windows and "rg.exe --files --type md" or "rg --files --type md",
}
